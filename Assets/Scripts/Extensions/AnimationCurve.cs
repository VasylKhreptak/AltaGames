namespace Extensions
{
    public static class AnimationCurve
    {
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public static float Evaluate(this UnityEngine.AnimationCurve curve, float min, float max, float i)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static float Evaluate(this UnityEngine.AnimationCurve curve, float minX, float maxX, float x, float minY, float maxY)
        {
